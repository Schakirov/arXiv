...
print("Running the next command:")
print('python arXiv-metadata-embetter.py "' + sys.argv[1] + '" "' + sys.argv[2] + '"')
os.system('python arXiv-metadata-embetter.py "' + sys.argv[1] + '" "' + sys.argv[2] + '"')
